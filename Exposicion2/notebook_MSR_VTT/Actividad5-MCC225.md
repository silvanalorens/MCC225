...
Proyecto : Recuperación de la disciplina deportiva dentro de las lista de imagenes /videos.
#### Idea central
...
Cada disciplina deportiva debe tener igual cantidad de muestras
Cross Atención entre imagen y texto
...
Buscador de disciplinas deportivas


#### Cuaderno 14

- Aporta el pipeline técnico de evaluación multimodal: modelo, datos, métricas, resultados, baseline y ejemplos.
A partir de las imágenes consecutivos de los videos deportivos y comparar los modelos visual Bert, viltBert.

#### Actividad complementaria

- Aporta la capa crítica: análisis de error, confiabilidad, explicabilidad, sesgo, limitaciones y uso responsable.
Sesgo estaría en el texto, se observa una imagen sola, carece de movimiento.
...
Es una base la actividad del cuaderno 14 actual.
Proyecto con componente multimodal texto-imagen
...
- Dos aciertos claros: Jugadores basquetball y tenis con contexto.
- Dos errores claros: Disciplinas erroneas con imagenes erroneos.
- Un caso ambiguo: disciplinas parecidas con vestimenta parecida en los jugadores
